...
`ogc.bbr.test.entities.CDIF-Discovery` *v0.1*
...
```json
{
    ...
    "schema:relatedLink": [
        {
            ...
            "schema:linkRelationship": {
                ...
                "schema:identifier": {
                    "@type": "schema:PropertyValue",
                    "schema:propertyID": "clbbbIvyDUyHNcOtU",
    ...
    "schema:keywords": [
        ...
        },
        {
            ...
            "schema:identifier": {
                "@type": "schema:PropertyValue",
                "schema:propertyID": "icJPoVwSFiPaG",
    ...
    "schema:variableMeasured": [
        {
            ...
            "schema:measurementTechnique": "aZmaWAAxw",
            "schema:unitText": "xlaP",
            "schema:unitCode": "i",
            "schema:minValue": 67,
            "schema:maxValue": 98,
            "schema:url": "http://example.com/resource?foo=bar#fragment"
        },
        {
            ...
            "schema:measurementTechnique": "zuWCzLjslmN",
            "schema:unitText": "B",
            "schema:unitCode": "JEOPbknfiqBzYKxvYl",
            "schema:minValue": 36,
            "schema:maxValue": 74,
            "schema:url": "http://example.com/resource?foo=bar#fragment"
        }
    ...
    "schema:subjectOf": {
        "@type": "schema:Dataset",
        "@id": "BAaR",
        "schema:about": {"@id": "MmRTcgOJPtRXedpTG"},
        "dcterms:conformsTo": [
...
```jsonld
{
  "@context": [
    ...
    "https://smrgeoinfo.github.io/OCGbuildingBlockTest/build/annotated/bbr/test/entities/CDIF-Discovery/context.jsonld",
    {
      "schema": "https://schema.org/",
      "dcterms": "http://purl.org/dc/terms/",
      "geosparql": "http://www.opengis.net/ont/geosparql#",
...
ex:YOPx a schema:Dataset ;
    schema:additionalType "test data description" ;
    schema:conditionsOfAccess "LCY",
        "ihYojbwJyw",
        "jNv",
        "tfmbDGeiuEnuhfKBvk" ;
    schema:contributor [ a schema:Role ;
            ...
            schema:roleName "editor" ],
        ex:NyMWPlRtQizAFE ;
    schema:creator ( ex:mxxInaV ex:jP ) ;
    schema:dateModified "2020-10-15" ;
    schema:datePublished "2021-09-05" ;
    schema:description "Auto generated from JSON schema, values are gobbledegoop. For testing" ;
    schema:distribution [ a schema:DataDownload ;
            ...
            schema:encodingFormat "text/csv" ;
            schema:name "VwuIdrCrJSsrGATePg" ;
            schema:provider ex:ABYcNWHKYhTiLLNEzJx ],
        [ a schema:DataDownload ;
            spdx:checksum [ spdx:algorithm "j" ;
                    spdx:checksumValue "h" ] ;
            schema:contentUrl "http://example.com/resource?foo=bar#fragment" ;
            schema:encodingFormat "kpZDvhyVo",
                "sMUGwSqxWzJOYEb",
                "tNdpXaJgDeWbFkNM" ;
            schema:name "MVMpmnCGAggEnsoEgJXH" ;
            schema:provider <file:///github/workspace/kNKPZsCSWMc>,
                ex:sr68lgy ] ;
    schema:funding [ a schema:MonetaryGrant ;
            schema:funder <https://ror.org/fnjrj68> ;
        ...
        [ a schema:MonetaryGrant ;
            schema:funder <https://ror.org/3572wjht> ;
            schema:identifier [ a schema:PropertyValue ;
                    schema:propertyID "rzWiEbKxAiYPBQlfJ" ;
                    schema:url "http://example.com/resource?foo=bar#fragment" ;
                    schema:value "lieopgXuumP" ] ;
            schema:name "fhhbzh" ],
        [ a schema:MonetaryGrant ;
            schema:funder <https://ror.org/sejer4w6u8> ;
            schema:identifier [ a schema:PropertyValue ;
                    schema:propertyID "HmJzdEZIaqUSLLte" ;
                    schema:url "http://example.com/resource?foo=bar#fragment" ;
                    schema:value "LZpo" ] ;
    ...
    schema:identifier [ a schema:PropertyValue ;
            ...
            schema:url "http://identifiers.org/sandbox/uSNzhqeEQPKhCj" ] ;
    schema:inLanguage "bYiJT" ;
    schema:keywords [ a schema:DefinedTerm ;
            schema:identifier [ a schema:PropertyValue ;
                    schema:propertyID "icJPoVwSFiPaG" ;
                    schema:url "http://example.com/resource?foo=bar#fragment" ;
                    schema:value "tdUMYBItIwdJe" ] ;
    ...
    schema:license "Kmp",
        "dXhuFoqL" ;
    schema:name "Test dataset" ;
    schema:provider <https://ada.org/person/5489>,
        ex:gDiAxjl,
        ex:ihjJtFPNEKnGSFBcgS ;
    schema:publisher ex:exampleOrg_fW ;
    schema:publishingPrinciples "rxZsrPAbJrIGGgDVJ" ;
    schema:relatedLink [ a schema:LinkRole ;
            :target [ a schema:EntryPoint ;
                    ...
                    schema:name "atsDYJxuhHpivqLmw" ;
                    schema:url "http://example.com/resource?foo=bar#fragment" ] ;
            schema:linkRelationship [ a schema:DefinedTerm ;
                    schema:identifier [ a schema:PropertyValue ;
                            schema:propertyID "kRF" ;
                            schema:url "http://example.com/resource?foo=bar#fragment" ;
                            schema:value "OuJNu" ] ;
        ...
        [ a schema:LinkRole ;
            ...
            schema:linkRelationship [ a schema:DefinedTerm ;
                    ...
                    schema:name "lfCzUaoftdtTPAhMnpC" ;
                    schema:termCode "EaApZcUMYjOM" ] ] ;
    schema:sameAs [ a schema:PropertyValue ;
            schema:value "urn:idorg:test:p45689" ] ;
    schema:subjectOf <file:///github/workspace/BAaR> ;
    schema:url "http://example.com/resource?foo=bar#fragment" ;
    schema:variableMeasured <file:///github/workspace/KJTFKurNFu>,
        ex:OjHgIDO ;
    schema:version "OVVAYgJhmFkXyVyedlVo" .

<file:///github/workspace/BAaR> a schema:Dataset ;
    dct:conformsTo [ ns1:id "ex:AbxQQMnD" ],
        [ ns1:id "ex:wjZwFKFIoCdVDlxdrF" ],
        [ ns1:id "ex:ESrkifcWtMnOisQmcXK" ] ;
    schema:about <file:///github/workspace/MmRTcgOJPtRXedpTG> ;
    schema:includedInDataCatalog <file:///github/workspace/lIZkH> ;
    schema:maintainer ex:PersonExample_zZc ;
    schema:sdDatePublished "2025-10-25" .

<file:///github/workspace/KJTFKurNFu> a schema:PropertyValue ;
    schema:description "EcbPmKQnMCgWozw" ;
    schema:maxValue 98 ;
    schema:measurementTechnique "aZmaWAAxw" ;
    schema:minValue 67 ;
    schema:name "RbMivCtraTmzms" ;
    schema:propertyID "GigjbPysIJ",
        "bXEOCTwvICRc",
        "yw" ;
    schema:unitCode "i" ;
    schema:unitText "xlaP" ;
...
<file:///github/workspace/kNKPZsCSWMc> a schema:Organization ;
    schema:alternateName "WFcslOjvGZY" ;
    schema:description "ztcLdOAkQTKSPLZ" ;
    schema:identifier [ a schema:PropertyValue ;
            schema:propertyID "ex:oFIYAymjuGCPjDnSgmB" ;
...
<file:///github/workspace/lIZkH> a schema:DataCatalog ;
    schema:identifier [ a schema:PropertyValue ;
            schema:propertyID "fGSg" ;
            schema:url "http://example.com/resource?foo=bar#fragment" ;
            schema:value "vPADlYJkJuGgI" ] ;
...
<https://ada.org/person/5489> a schema:Person ;
    schema:email "a.king@nhm.ac.uk" ;
    schema:identifier "https://orcid.org/0000-0001-6113-5417" ;
    schema:name "King, Ashley" .

ex:ABYcNWHKYhTiLLNEzJx a schema:Person ;
    schema:affiliation ex:corzCgjNrGcH ;
    schema:alternateName "H" ;
...
ex:OjHgIDO a schema:PropertyValue ;
    schema:description "RGKBMBkScTTNQ" ;
    schema:maxValue 74 ;
    schema:measurementTechnique "zuWCzLjslmN" ;
    schema:minValue 36 ;
    schema:name "jzgZCegiTFYBSmsSh" ;
    schema:propertyID "CUXfWZLdRkEAG",
        "tzysaGTv" ;
    schema:unitCode "JEOPbknfiqBzYKxvYl" ;
    schema:unitText "B" ;
    schema:url "http://example.com/resource?foo=bar#fragment" .

ex:corzCgjNrGcH a schema:Organization ;
    schema:additionalType "schema:NGO" ;
    schema:alternateName "leJqYoxQIH" ;
    schema:description "vRzzUAmtNWLgZcgNIC" ;
    schema:identifier [ a schema:PropertyValue ;
...
ex:mxxInaV a schema:Organization ;
    schema:affiliation ex:xblzSwEYJKBPpkK ;
    schema:alternateName "MwsoNGVEp" ;
    schema:contactPoint [ a schema:ContactPoint ;
            schema:email "t" ] ;
    schema:description "ypZ" ;
    schema:identifier [ a schema:PropertyValue ;
            ...
            schema:value "JqLmJhoyFPhsmW" ] ;
    schema:name "AEbcNvM" ;
    schema:sameAs "ex:IgH",
        "ex:pMPylNhiMvfC" .

ex:xblzSwEYJKBPpkK a schema:Organization ;
    schema:additionalType "schema:GovernmentOrganization",
        "schema:Project",
        "schema:ResearchOrganization" ;
    schema:alternateName "TrAuXgjTOCmJVTaf" ;
    schema:description "wwcOQoCbUe" ;
...
```json
{
    ...
    "schema:license":[{"@id":"http://www.opengis.net/def/nil/OGC/0/missing"}],
    "schema:distribution": [
        {
            "@type": ["schema:DataDownload"],
...
<file:///github/workspace/#ea1b4bca7e1d1b01b466b7c8aa377a79> a schema:Dataset ;
    spdx:checksum "e669b4a4aee3488e635b94a0a790f42f5b04aaca21679e429e005a2f403f4605" ;
    schema:about <file:///github/workspace/#18d65475a618cf414ee568fc801c164b> ;
    schema:description "" ;
    schema:encodingFormat "application/yaml" ;
    schema:name "20230928_XRD_JSC-ARES_OREX-500005-0_1_plot_1.yaml" ;
    schema:size [ a schema:QuantitativeValue ;
            schema:unitText "byte" ;
            schema:value 213 ] .

<file:///github/workspace/#f2aec1be3078bdacf5e68570a5af7690> a schema:Dataset ;
    spdx:checksum "f2092bb9336d1dc718ce56d7c92912038d8556c17d814a978a8351898567af23" ;
    schema:about <file:///github/workspace/#c7e1fba9edcb558853eae3ab879b0c92> ;
    schema:description "" ;
    schema:encodingFormat "application/yaml" ;
    schema:name "20230928_XRD_JSC-ARES_OREX-500005-0_1_instrumentMetadata_1.yaml" ;
    schema:size [ a schema:QuantitativeValue ;
...
<file:///github/workspace/#f4f6382d0c78fa623d6262d357ed43ce> a schema:Dataset ;
    spdx:checksum "37be2186d5fcd22e6695aca0d3fe903fce95b580c558b0d4e957751b062f2221" ;
    schema:about <file:///github/workspace/#45cdecbbbf9f72f25aa8bdad035680b4> ;
    schema:description "" ;
    schema:encodingFormat "application/yaml" ;
    schema:name "20230928_XRD_JSC-ARES_OREX-500005-0_1_XRDTabular_1.yaml" ;
    schema:size [ a schema:QuantitativeValue ;
...
ada:metadata_44 a schema:Dataset ;
    dct:conformsTo <file:///github/workspace/CDIF_basic_1.0>,
        ...
        ada:plot,
        ada:tabularData ;
    schema:about ada:record_44 ;
    schema:creator <https://ada.org/person/3479> ;
    schema:dateModified "2024-06-20" ;
    schema:description "metadata about documentation for https://doi.org/10.60707/2j0t-gq80" .

ada:record_44 a schema:Dataset,
        schema:Product ;
    prov:wasGeneratedBy [ a prov:Activity,
            ...
            schema:location [ a schema:Place,
                    ...
                    schema:identifier "" ;
                    schema:name "NASA Johnson Space Center" ] ;
            schema:mainEntity [ a schema:Thing,
                        <https://w3id.org/isample/vocabulary/materialsampleobjecttype/materialsample> ;
                    schema:additionalType "MaterialSample" ;
                    schema:identifier "OREX-500005-0" ] ;
            schema:startDate "2024-01-28T14:06:04.101222+00:00" ] ;
    schema:additionalType "X-ray diffraction" ;
    schema:creator ( <https://ada.org/person/5489> ) ;
    schema:dateModified "2024-06-20" ;
    schema:datePublished "2024-06-20" ;
    schema:description "JSC-ARES Panalytical XRD data for sample OREX-500005-0" ;
    schema:distribution [ a schema:DataDownload ;
            ...
            schema:description "this data product is distributed in zip archive; contents of the archive are listed as parts. The component files are not individually accessible" ;
            schema:encodingFormat "application/zip" ;
            schema:hasPart <file:///github/workspace/#18d65475a618cf414ee568fc801c164b>,
    ...
    schema:funding [ a schema:MonetaryGrant ;
            schema:description "This material is supported by NASA under contract NNM10AA11C issued through the New Frontiers program." ;
            schema:funder <https://ror.org/027ka1x80> ;
            schema:name "New Frontiers program, OSIRIS-REx" ] ;
    schema:identifier [ a schema:PropertyValue ;
            schema:propertyID "https://registry.identifiers.org/registry/doi" ;
            schema:url "https://doi.org/10.60707/2j0t-gq80" ;
    ...
    schema:measurementTechnique [ a schema:DefinedTerm ;
            schema:name "X-ray diffraction" ;
            schema:termCode "XRD" ] ;
    schema:name "JSC-ARES Panalytical XRD data for sample OREX-500005-0" ;
    schema:subjectOf ada:metadata_44 ;
    schema:url "http://www.opengis.net/def/nil/OGC/0/missing" ;
    schema:variableMeasured <file:///github/workspace/#angle>,
        <file:///github/workspace/#intensity> .

<https://ada.org/person/3479> a schema:Person ;
    schema:email "smrTucson@email.org" ;
    schema:identifier "https://orcid.org/0000-0002-7933-2154" ;
    schema:name "Richard, Stephen M." .
...
<file:///github/workspace/#18d65475a618cf414ee568fc801c164b> a schema:Dataset ;
    :fileDetail [ a ada:image,
                schema:DigitalDocument ;
            :componentType "ada:plot" ;
            :numPixelsX 2178 ;
            :numPixelsY 2178 ] ;
...
<file:///github/workspace/#45cdecbbbf9f72f25aa8bdad035680b4> a schema:Dataset ;
    :fileDetail [ a cdi:PhysicalDataSet,
                ada:tabularData ;
...
<file:///github/workspace/#angle> a schema:PropertyValue ;
    cdi:unitOfMeasureKind "missing" ;
    schema:description "Angle of the detector in 2theta" ;
    schema:name "Angle" ;
    schema:propertyID "missing" .

<file:///github/workspace/#c7e1fba9edcb558853eae3ab879b0c92> a schema:Dataset ;
    spdx:checksum "255c055e7e7937f318e0db6a2847319618538f7caa40ac4e598173669955ab7d" ;
    schema:description "Metadata for Panalytical XRD analysis of sample OREX-500005-0" ;
    schema:encodingFormat "text/plain" ;
    schema:name "20230928_XRD_JSC-ARES_OREX-500005-0_1_instrumentMetadata_1.txt" ;
...
<file:///github/workspace/#intensity> a schema:PropertyValue ;
    cdi:unitOfMeasureKind "missing" ;
    schema:description "Intensity of diffracted X-rays in counts" ;
    schema:name "Intensity" ;
    schema:propertyID "missing" .
...
* YAML version: [schema.yaml](https://smrgeoinfo.github.io/OCGbuildingBlockTest/build/annotated/bbr/test/entities/CDIF-Discovery/schema.json)
* JSON version: [schema.json](https://smrgeoinfo.github.io/OCGbuildingBlockTest/build/annotated/bbr/test/entities/CDIF-Discovery/schema.yaml)
...
[context.jsonld](https://smrgeoinfo.github.io/OCGbuildingBlockTest/build/annotated/bbr/test/entities/CDIF-Discovery/context.jsonld)
...
* Path: `_sources/entities/CDIF-Discovery`
