...
```jsonld
{
  "@context": "https://smrgeoinfo.github.io/OCGbuildingBlockTest/build/annotated/bbr/metadata/profiles/adaXANES/context.jsonld",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
...
[] a ns1:Dataset,
    ...
    ns1:additionalType "ada:DataDeliveryPackage",
        "ada:XANESImageStack" ;
    ns1:description "X-ray Absorption Near Edge Structure (XANES) data" ;
    ns1:name "XANES Analysis of Sample" .
...
* YAML version: [schema.yaml](https://smrgeoinfo.github.io/OCGbuildingBlockTest/build/annotated/bbr/metadata/profiles/adaXANES/schema.json)
* JSON version: [schema.json](https://smrgeoinfo.github.io/OCGbuildingBlockTest/build/annotated/bbr/metadata/profiles/adaXANES/schema.yaml)
...
[context.jsonld](https://smrgeoinfo.github.io/OCGbuildingBlockTest/build/annotated/bbr/metadata/profiles/adaXANES/context.jsonld)
