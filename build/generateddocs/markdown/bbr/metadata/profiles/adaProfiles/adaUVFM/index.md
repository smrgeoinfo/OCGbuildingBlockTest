...
```json
{
  ...
  "schema:additionalType": ["Fluorescence Microscopy (UVFM) Image", "ada:DataDeliveryPackage"],
...
```jsonld
{
  "@context": "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaUVFM/context.jsonld",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
...
[] a schema1:Dataset,
    ...
    schema1:additionalType "Fluorescence Microscopy (UVFM) Image",
        "ada:DataDeliveryPackage" ;
    schema1:description "Ultraviolet Fluorescence Microscopy (UVFM) data" ;
    schema1:name "UVFM Analysis of Sample" .
