...
```json
{
  ...
  "schema:additionalType": ["Elemental Analysis-Isotope Ratio Mass Spectrometry (EA-IRMS)", "ada:DataDeliveryPackage"],
...
```jsonld
{
  "@context": "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaEAIRMS/context.jsonld",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
...
[] a schema1:Dataset,
    ...
    schema1:additionalType "Elemental Analysis-Isotope Ratio Mass Spectrometry (EA-IRMS)",
        "ada:DataDeliveryPackage" ;
    schema1:description "Elemental Analysis - Isotope Ratio Mass Spectrometry (EA-IRMS) data" ;
    schema1:name "EA-IRMS Analysis of Sample" .
