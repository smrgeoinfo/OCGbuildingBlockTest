...
```json
{
  ...
  "schema:additionalType": ["Resonance ionization time of flight noble gas mass spectrometry (RITOFNGMS) Spectra", "ada:DataDeliveryPackage"],
...
```jsonld
{
  "@context": "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaRITOFNGMS/context.jsonld",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
...
[] a schema1:Dataset,
    ...
    schema1:additionalType "Resonance ionization time of flight noble gas mass spectrometry (RITOFNGMS) Spectra",
        "ada:DataDeliveryPackage" ;
    schema1:description "Resonance Ionization Time-of-Flight Noble Gas Mass Spectrometry (RI-TOF-NGMS) data" ;
    schema1:name "RI-TOF-NGMS Analysis of Sample" .
