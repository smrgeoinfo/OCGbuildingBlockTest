...
```json
{
  ...
  "schema:additionalType": ["Laser Assisted Fluorination (LAF) Processed", "ada:DataDeliveryPackage"],
...
```jsonld
{
  "@context": "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaLAF/context.jsonld",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
...
[] a schema1:Dataset,
    ...
    schema1:additionalType "Laser Assisted Fluorination (LAF) Processed",
        "ada:DataDeliveryPackage" ;
    schema1:description "Laser-Assisted Fluorination (LAF) data" ;
    schema1:name "LAF Analysis of Sample" .
