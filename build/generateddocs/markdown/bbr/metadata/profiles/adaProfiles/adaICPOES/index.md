...
```json
{
  ...
  "schema:additionalType": ["Inductively Coupled Plasma - Optical Emission Spectroscopy (ICPOES) Raw", "ada:DataDeliveryPackage"],
...
```jsonld
{
  "@context": "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaICPOES/context.jsonld",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
...
[] a schema1:Dataset,
    ...
    schema1:additionalType "Inductively Coupled Plasma - Optical Emission Spectroscopy (ICPOES) Raw",
        "ada:DataDeliveryPackage" ;
    schema1:description "Inductively Coupled Plasma Optical Emission Spectrometry (ICP-OES) data" ;
    schema1:name "ICP-OES Analysis of Sample" .
