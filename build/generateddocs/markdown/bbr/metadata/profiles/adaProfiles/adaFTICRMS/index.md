...
```json
{
  ...
  "schema:additionalType": ["Fourier Transform Ion Cyclotron Resonance Mass Spectrometry (FTICRMS) Cube", "ada:DataDeliveryPackage"],
...
```jsonld
{
  "@context": "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaFTICRMS/context.jsonld",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
...
[] a schema1:Dataset,
    ...
    schema1:additionalType "Fourier Transform Ion Cyclotron Resonance Mass Spectrometry (FTICRMS) Cube",
        "ada:DataDeliveryPackage" ;
    schema1:description "Fourier Transform Ion Cyclotron Resonance Mass Spectrometry (FTICR-MS) data" ;
    schema1:name "FTICR-MS Analysis of Sample" .
