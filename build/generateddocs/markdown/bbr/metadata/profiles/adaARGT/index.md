...
```json
{
            ...
            "prov:used": [
                {
                    ...
                    "schema:additionalType": "ada:ARGTInstrument",
    ...
    "schema:subjectOf": {
        ...
        "dcterms:conformsTo": [
            ...
            {
                "@id": "https://ada.astromat.org/profiles/adaARGT"
            }
        ],
        "schema:maintainer": {
            "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaARGT/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
    ...
    prov:wasGeneratedBy [ a schema1:Event,
            ...
            prov:used [ a schema1:Product,
                    ...
                    schema1:additionalProperty [ a schema1:PropertyValue ;
                            ...
                            schema1:propertyID "ada:argtSetting" ;
...
ex:adaARGT-file-002 a schema1:CreativeWork,
        ada:document ;
...
ex:adaARGT-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://ada.astromat.org/profiles/adaARGT>,
