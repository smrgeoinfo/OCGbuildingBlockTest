...
```json
{
  ...
  "schema:additionalType": ["ada:GPYCProcessedTabular", "ada:DataDeliveryPackage"],
...
```jsonld
{
  "@context": "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaGPYC/context.jsonld",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
