...
```jsonld
{
  "@context": "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaSIMS/context.jsonld",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
...
[] a ns1:Dataset,
    ...
    ns1:additionalType "ada:DataDeliveryPackage",
        "ada:SIMSTabular" ;
    ns1:description "Secondary Ion Mass Spectrometry (SIMS) data" ;
    ns1:name "SIMS Analysis of Sample" .
